...
export default function Header() {
    const { currentlyChatting, server, isOwner } = useServerStore();
    ...
    return (
        <div className="p-5 border-b border-gray-500/20 flex justify-between items-center bg-white/5 backdrop-blur-[1px]">
            <div className="flex items-center gap-4">
                {isOwner && <div className="h-10 w-10 cursor-pointer active:scale-90 group rounded-full bg-white/20 active:opacity-40 flex items-center justify-center">
